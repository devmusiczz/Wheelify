  ...
  return (
    <div className="bg-[#121212]">
      ...
      <div className="mt-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
        <h1 className="text-2xl text-white">Featured Products</h1>
      ...
      <div className="mt-24">
        <h1 className="text-2xl text-white px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 mb-12">
          Categories
        </h1>
        <Suspense fallback={<Skeleton />}>
          <CategoryList />
      ...
      <div className="mt-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
        <h1 className="text-2xl text-white">New Products</h1>
        <Suspense fallback={<Skeleton />}>
          <ProductList
