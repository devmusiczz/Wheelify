...
const Footer = () => {
  return (
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-black  text-sm mt-24">
      {/* TOP */}
        ...
        <div className="hidden lg:flex justify-between w-1/2">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-6">
              ...
              <Link href="">Cars</Link>
              <Link href="">All Automobile Accesories</Link>
            </div>
          </div>
          <div className="flex flex-col justify-between">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">© 2024 DevMusicz</div>
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          <div className="">
            ...
            <span className="font-medium">Rs Ruppees</span>
          </div>
        </div>
      </div>
    </div>
